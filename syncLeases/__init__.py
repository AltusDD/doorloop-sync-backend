import logging
logging.info(">>> Global import reached: syncLeases")
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        logging.info(">>> All imports successful in syncLeases")
        ...
        logging.error(f"❌ Failed in syncLeases: {str(e)}\n{tb}")
        return func.HttpResponse(f"❌ Error in syncLeases: {str(e)}\n{tb}", status_code=500)
