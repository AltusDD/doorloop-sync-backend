...
ENDPOINTS = {
    ...
    "notes": "notes",
    "files": "files",
    "property-groups": "property_groups",

    # ✅ Additional endpoints from DoorLoop API - Relationships.docx
    "contacts": "contacts",
    ...
    "owners-distributions": "owners_distributions",
    "owners-contributions": "owners_contributions",
