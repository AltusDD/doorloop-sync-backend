...
def run():
    logging.info("🔄 Starting normalization for applications")

    supabase = SupabaseClient()
    raw_table = "doorloop_raw_applications"
    normalized_table = "doorloop_normalized_applications"
    ...
    logging.info(f"✅ Normalized {len(normalized)} applications records")
