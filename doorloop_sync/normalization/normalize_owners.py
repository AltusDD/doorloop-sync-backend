...
def run():
    logging.info("🔄 Starting normalization for owners")
    ...
    if not raw_records:
        logging.info("📭 No raw data found for owners. Task complete.")
        return
    ...
    logging.info(f"✅ Normalized {len(normalized)} owners records")
