...
def run():
    logging.info("🔄 Starting normalization for recurring_charges")
    ...
    if not raw_records:
        logging.info("📭 No raw data found for recurring_charges. Task complete.")
        return
    ...
    logging.info(f"✅ Normalized {len(normalized)} recurring_charges records")
