...
def run():
    """
    Normalizes raw fees data from Supabase and upserts it into the
    doorloop_normalized_fees table.
    """
    entity_name = "fees"
    raw_table = "doorloop_raw_fees"
    normalized_table = "doorloop_normalized_fees"
