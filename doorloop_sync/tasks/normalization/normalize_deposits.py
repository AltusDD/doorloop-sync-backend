...
def run():
    """
    Normalizes raw deposits data from Supabase and upserts it into the
    doorloop_normalized_deposits table.
    """
    entity_name = "deposits"
    raw_table = "doorloop_raw_deposits"
    normalized_table = "doorloop_normalized_deposits"
