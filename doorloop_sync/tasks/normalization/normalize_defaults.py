...
def run():
    """
    Normalizes raw defaults data from Supabase and upserts it into the
    doorloop_normalized_defaults table.
    """
    entity_name = "defaults"
    raw_table = "doorloop_raw_defaults"
    normalized_table = "doorloop_normalized_defaults"
