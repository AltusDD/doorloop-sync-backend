...
def run():
    """
    Normalizes raw contacts data from Supabase and upserts it into the
    doorloop_normalized_contacts table.
    """
    entity_name = "contacts"
    raw_table = "doorloop_raw_contacts"
    normalized_table = "doorloop_normalized_contacts"
