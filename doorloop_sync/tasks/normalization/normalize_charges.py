...
def run():
    """
    Normalizes raw charges data from Supabase and upserts it into the
    doorloop_normalized_charges table.
    """
    entity_name = "charges"
    raw_table = "doorloop_raw_charges"
    normalized_table = "doorloop_normalized_charges"
