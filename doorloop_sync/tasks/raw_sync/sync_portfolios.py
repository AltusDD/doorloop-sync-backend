...
def sync_portfolios():
    """
    Fetches all portfolios (property groups) from DoorLoop and upserts them
    into the 'portfolios' table.
    """
    entity = "portfolios"
    ...
    try:
        ...
        # Note: The endpoint is /property-groups in the API
        all_records = client.get_all("/api/property-groups")
        ...
        supabase.insert_records("portfolios", normalized_records, entity)
