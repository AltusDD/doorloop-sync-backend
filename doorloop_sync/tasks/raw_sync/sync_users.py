...
def sync_users():
    """
    Fetches all users from DoorLoop and upserts them into the 'users' table.
    """
    entity = "users"
    ...
    try:
        ...
        all_records = client.get_all("/api/users")
        ...
        supabase.insert_records("users", normalized_records, entity)
