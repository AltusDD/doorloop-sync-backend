...
class SupabaseSchemaManager:
    ...
    def ensure_schema(self, table_name: str, api_schema: dict):
        """
        ...
        for api_field, field_props in api_schema.items():
            ...
            # Convert API field name to snake_case column name
    ...
    def infer_type_from_api_props(self, field_props: dict) -> str:
        """Infers PostgreSQL type from API schema properties."""
