...
# This ensures logs from this file are captured by the main logging setup
...
def fetch_all_doorloop_records(endpoint: str, base_url: str, token: str) -> List[Dict[str, Any]]:
    ...
    while True:
        ...
        try:
            ...
            # Only log body for non-200 or if it's not JSON (to avoid huge logs)
            ...
            raise # Re-raise to be caught by master sync
